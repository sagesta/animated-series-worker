...
| 2 | MODEL-LIC-QUAL | LTX accepted; remaining core approval blocked | Retain the individual LTX acceptance; decide core Qwen/Gemma obligations and voice-rights boundaries. LatentSync/its Stability VAE are policy-excluded from core until a separate binding weight-license review succeeds | Named, dated accepted decisions for every policy-eligible core model; no inferred permission |
