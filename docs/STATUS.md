...
| Desktop shell | In progress — secure shell, guided project wizard, shared asterisks/live constraints/correction summaries, RunPod account setup, navigation, unpacked app smoke, and unsigned NSIS installer build pass on the development machine | Automated accessibility, Authenticode signing, and clean-machine/non-technical install/launch evidence |
...
- The full version-0.7.0 quality gate passes. A separate `release-smoke-0.7.0-final2/win-unpacked/Animated Series Studio.exe` reports product version `0.7.0.0`, SHA-256 `8091E40BB747C61D0356E88206682F1CE195913F0BABAE54260CE1CBBFBB1969`, 235,534,336 bytes, and Authenticode status `NotSigned`. It is a developer test artifact, not an installer, signed release, automated-accessibility result, or clean-machine runtime proof.
