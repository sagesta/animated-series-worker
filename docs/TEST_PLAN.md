...
| Workflow-registry/config/worker tests | Prove hash-locked control-guided Qwen/LTX graphs, exact model-free foley and official LTX trainer contracts, adaptation sample hash checks, runtime/source pins, core-image exclusion of the trainer, core-only promotion, and non-billable advanced locks | No model/GPU output-quality proof; all AT-043/AT-045/AT-047–AT-049 external gates remain |
