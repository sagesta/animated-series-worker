...
| NFR-007 portability | Partial | Canonical schema-1 `project.json`, documented folder layout, rebuildable local catalog, full SHA-256 inventory backups, and non-overwriting verified restore | Incremental/release archives, export, representative media recovery, and clean-machine AT-030 |
