...
| FR-011–FR-023, FR-049–FR-051 | Media store, identity/edit/voice/video job contracts, approved-input lineage, local media protocol, viewing/approval, final-I2V `8n+1` frame planning plus strict requested-duration slicing, exact candidate/transitive model-license evidence, individual LTX acceptance, and restrictive LatentSync core exclusion are implemented | Targeted 1/2/4-second GPU proof, remaining core license decisions, exact remote workflow/model qualification, separately licensed lip repair, and season-scale continuity |
